...
\newcommand{\ProfileSummary}{Ingeniero de IA con experiencia full-stack en construccion y entrega de sistemas en produccion con Python, Ruby on Rails, React y plataformas cloud.}
\ifthenelse{\equal{\CVProfile}{academic}}{
    \renewcommand{\ProfileSummary}{M.C. en Ciencias de la Computacion con experiencia docente y de mentoria, enfocado en educacion de IA/ML y proyectos aplicados que conectan investigacion y producto.}
}{}
